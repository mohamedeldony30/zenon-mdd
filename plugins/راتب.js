...
let time = global.db.data.users[m.sender].lastcofre + 360000 // 36000000 10 Horas //86400000 24 Horas
if (new Date - global.db.data.users[m.sender].lastcofre < 360000) throw `[❗تحذير❗] لقد اخذت مرتبك اليومي ب الفعل\nامامك من الوقت *${msToTime(time - new Date())}* انتظر حتي يمر الوقت يا نصاب🙂`
 
let img = 'https://img.freepik.com/vector-gratis/cofre-monedas-oro-piedras-preciosas-cristales-trofeo_107791-7769.jpg?w=2000'
let dia = Math.floor(Math.random() * 300)
let limit = Math.floor(Math.random() * 300)
