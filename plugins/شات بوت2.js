...
if (/^صليت$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `تقبل الله`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}

if (/^يلا نلعب$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `خدوني معاكو مش هعمل صوت😀`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}

if (/^تصبحو علي خير$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `وانتا من اهل خير♥️`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}
...
if (/^احمد كانكي$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `نأب زينون ❤️`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}
 ...
     conn.reply(m.chat, ` قول نعم يا حب 🫶🏻 🐦❤`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
   ...
   if (/^شادو|الجزار|زينون|ايتاشي$/i.test(m.text) ) { //sem prefixo
 ...
     conn.reply(m.chat, `اوهايو كوزيماس `, m) //wm, null, [['Menu', '#menu']], m) botones :V
   ...
   if (/^ايانو|فينوم|مايكي|سابو|هيما$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat,'صديق زينون الروح بروح 😂❤', m) //wm, null, [['Menu', '#menu']], m) botones :V
 ...
 if (/^اذهب الى الجحيم$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `kkk 🥺💔`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
